...
type HotkeysConfig struct {
	...
	MarkActive   string `yaml:"mark_active"`
	MarkAFK      string `yaml:"mark_afk"`
	MarkMenu     string `yaml:"mark_menu"`
	MarkLoading  string `yaml:"mark_loading"`
}
...
func Default() *Config {
	...
	cfg.Hotkeys.MarkActive = "ctrl+shift+a"
	cfg.Hotkeys.MarkAFK = "ctrl+shift+f"
	cfg.Hotkeys.MarkMenu = "ctrl+shift+m"
	cfg.Hotkeys.MarkLoading = "ctrl+shift+l"
